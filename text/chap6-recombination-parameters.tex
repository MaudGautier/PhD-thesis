...
\begin{figure}[t]
	...
	{\textbf{Correlation between the expected and observed proportions of CAST-donor fragments across hotspots displaying at least 5 events.}
		\par The expected proportion of CAST-donor fragments (x-axis) was based on the probability of the DSB to initiate on the B6 haplotype from DMC1 ssDNA-sequencing (SSDS) data by \citet{smagulova2016evolutionary} (see main text).
		Only the 582 hotspots displaying a minimum of 5 recombination events are reported in this figure.
...
Our simple and intuitive way of assigning its donor to each fragment is thus sufficient to explain, at the hotspot scale, most of the variance due to DSB initiation bias and should also be trustworthy at the scale of single fragments.
