...
Interestingly, in mice, the transmission bias on multiple-marker NCOs ($b_0^{NCO_{2+}}$) is extremely weak as compared to that for single-marker NCOs ($b_0^{NCO_{1}}$) (see Chapter~\ref{ch:7-quantification-BGC}).
