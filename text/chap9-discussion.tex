...
All in all thus, our method was much more powerful than pedigree analyses: the number of events detected per Gb sequenced with our method (77.1 events/Gb) was over 100 times as great as that of a recent study carried on mice by \citet{li2018highresolution} (0.604 events/Gb).
...
The gBGC coefficient ($b$) can be decomposed into the recombination rate $r$, the conversion tract length $L$ and transmission bias $b_0$ of COs and NCOs in the following way:
...
\begin{table}[t]
	...
	\begin{tabular}{rrrrrrrrr}
		...
		\toprule
		& \multicolumn{4}{c}{\textbf{Paternal events}} &  \multicolumn{4}{c}{\textbf{Maternal events}}  \\
	...
	\end{tabular}
	\end{adjustbox}
	\caption[Frequency of S\textrightarrow{} W and W\textrightarrow{} S transmission frequencies in human data from \citet{halldorsson2016rate}]
	{\textbf{Frequency of S\textrightarrow{} W and W\textrightarrow{} S transmission frequencies in human data from \citet{halldorsson2016rate}.}
...
Indeed, the hybrid mice that we analysed descended from crosses between two strains which displayed distinct \textit{Prdm9} alleles.
