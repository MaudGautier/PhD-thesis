...
\subsubsection{\mccorrect{Interference}}
...
These findings suggested that recombination between alleles (in this case, between the second and third marker) are negatively associated with recombination in neighbouring regions (in this case, between the first and second, and between the third and fourth markers). This feature was designated as ‘\mccorrect{interference}’.
...
To sum up, over the course of the 1950's and of the early 1960's, numerous studies evidenced that crossing-over was associated with gene conversion, PMS, polarised recombination and \mccorrect{interference}.
...
% and the formation and resolution of a Holliday junction, i.e.\ the linking of two DNA duplexes.\\
...
% the formation of a DNA double-strand break (DSB) on one chromosome is ensued by strand exchanges and the establishment of a double-Holliday junction

% , according to which recombination is initiated by DNA double-strand breaks (DSBs)
% and that will be detailed in Chapter~\ref{ch:2-recombination-mechanistics}: the double-strand break repair (DSBR) model \citep{szostak1983doublestrandbreak}.

% laid the foundations for
% Though, because experimental observations revealed that not all heteroduplex DNA were symmetric, Matthew Meselson (born 1930) and Charles Radding (born 1946) proposed another model where a Holliday structure would be generated by a single-strand nick in only one chromosome \citep{meselson1975general}.
% Only a few years later, the latter model was replaced by one that is still used today and that will be detailed in Chapter~\ref{ch:2-recombination-mechanistics}: the double-strand break repair (DSBR) model \citep{szostak1983doublestrandbreak}.
%
...
% studied the continuous variation of characteristics within populations.
...
% another British geneticist, John B.\ S.\ Haldane (1892--1964), derived equations of allele frequency change at a single locus under a broad range of conditions in a series of ten papers named \textit{\usebibentry{haldane1927mathematical}{title}} \citeyearpar{haldane1927mathematical} and, with this, re-established natural selection as the major cause of evolution \citep{haldane1932causes}.
...
% defined it with distinct postulates but with all included natural selection working on heritable variation supplied by mutation \citep{mayr1959where,stebbins1966processes,dobzhansky1974chance}.

% Though, this synthesis has been challenged with the arrival of the neutral theory
...
% As of today, the controversy is no longer strictly dichotomous but rather concerns the quantitative portion of adaptive and non-adaptive mutations.
...
% on regions of the genome neighbouring the selected region.
...
% impacts plays an important role in genome evolution.
...
% % Such observation suggested that a force linked to recombination created differences in levels of variation:
% % beyond purifying natural selection and genetic drift
%
%
% - donc la recombinaison en tant que tel joue un role important dans l'evolution des genomes.
% - mais
% until we know more about genetic systems at a molecular
% % level we cannot say whether the events in the theory bear any relation to the
% % process involved in the initial evolution of recombination
%
%
% Place de la recombinaison dans l'evolution des genomes: Hill-Robertson et Muller's ratchet — voir papier Felsenstein
% - nat sel favours modifiers that reduce recombi. So hy is it maintained: Muller and Fisher theory (but controversed) — Felsenstein — mais, seulement theories, et il faut aussi comprendre les mecanismes moleculaires, cf chap 2.
%
%
% Muller
%
...
% parler du BGC qui est une consequence de la recombi
%
% - pour tous: mutation est la source, puis sel nat et drift (avec importance relative)
% - puis role de la recombinaison
% - developper sel nat, drift, mut, BGC
% - et muller's ratchet + Hill-Robertson
...
%Conclusion du chapitre precendent. Genetics is the study of heredity, i.e.\ the process through which parents pass on traits to their offspring. In the next chapter, we will focus on meiotic recombination.
