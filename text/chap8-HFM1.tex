...
This requires the use of individuals homozygous for the \mccorrect{mutant} version of the gene but nonetheless displaying a high level of heterozygosity for recombination to be detectable.
...
\mccorrect{This implementation was as powerful as the original method and we could thus study the role of the interaction between HFM1 and MLH1:
