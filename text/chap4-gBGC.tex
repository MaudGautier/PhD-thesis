...
Gene conversion, i.e.\ the process through which one DNA sequence is cleaved and non-reciprocally replaced by another one (the homologue in the case of allelic gene conversion), leads to the non-Mendelian segregation of genetic information at the locus where it occured. 
