...
These various approaches have allowed to quantify gBGC in several organisms and, thus, to investigate its relationship with other parameters of genome evolution.
...
In birds \citep{smeds2016highresolution} and rice \citep{si2015widely} too, gBGC was also directly observed in NCO CTs (GC-bias: 59\% in both cases), but gBGC could not be tested in CO CTs either.
