...
Several observations of the gBGC model would also be observed under selection.
...
More generally, the dynamics of the fixation process for one locus is identical under BGC and natural selection \citep{nagylaki1983evolution}, hence the reason why the first observations were interpreted as the result of natural selection \citep{eyre-walker1999evidence}.
In this subsection, I review other cases where the effects of gBGC interfere with natural selection.
...
% \subsection{Deleterious effects of GC-biased gene conversion (gBGC)}
