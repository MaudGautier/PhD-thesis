...
\begin{table}[b!]
	...
	\begin{adjustbox}{width = 1\textwidth}
		\begin{tabular}{rrrrrrr}
			...
			$Rec$-$1S$                 & 9355 & 9433 & 0.4979 & 0.4907--0.5051 & 0.5743 & - \\
			$Rec$-$2S$                 & 5051 & 5028 & 0.5011 & 0.4913--0.5109 & 0.8265 & - \\
...
% From then on, gBGC could be quantified in the CTs\textsuperscript{$\star$} of the recombination events detected.

On the other hand, inside CTs\textsuperscript{$\star$}, the proportion of \textit{S} alleles found in the pool of gametes is significantly above the 0.5 null hypothesis of a Mendelian transmission, for both Rec-1S and Rec-2S ($p-value < 0.05$) (Table \ref{tab:gBGC-values}).


Altogether, these findings prove (1) that our per-hotspot equalisation procedure allows to efficiently decouple dBGC and gBGC effects by controlling for the dBGC effect and (2) that a significant, albeit weak, transmission bias favouring \textit{S} alleles exists in mice. 
