...
\begin{mccorrection}
These methods do not rely on the existence of polymorphic markers and, therefore, depend on the size of the region bound by the protein.
...
Multimer formation certainly plays a role in PRDM9-mediated homologue pairing \citep{davies2016reengineering} and dominance may affect the dosage sensitivity of PRDM9 \citep{flachs2012interallelic, segurel2011case} and thus participate in both hybrid infertility — which was observed long before the known implication of \textit{Prdm9} \citep{forejt1974genetic} — and in speciation \citep{mihola2009mouse}.
...
Therefore, \citet{lesecque2014red} experimentally quantified the dynamics of hotspot turnover by estimating the age and life expectancy of human hotspots.
...
As such, they experimentally proved that dBGC was indeed sufficiently strong to explain the rapid loss of hotspots.
