...
% Observation des motifs+ decouverts dans trois groupes en meme temps
...
% Nevertheless, a PRDM9-independent pathway for hotspot specification seems to exist in mammals \citep{smagulova2011genomewide,narasimhan2016health} and no functional \textit{Prdm9} gene exists in canids \citep{axelsson2012death,munoz-fuentes2011prdm9,auton2013genetic} nor birds \citep{singhal2015stable} for which hotspots stably locate at transcription start sites (TSSs) instead.

Nevertheless, even if PRDM9-lacking mice are recombination-deficient and thus sterile \citep{brick2012genetic}, a PRDM9-independent pathway for hotspot specification seems to exist \citep{smagulova2011genomewide} and to guarantee fertility in certain mammalian cases \citep{narasimhan2016health}. 
Hotspots are also defined independently of PRDM9 in canids \citep{axelsson2012death,munoz-fuentes2011prdm9,auton2013genetic} and birds \citep{singhal2015stable} in which hotspot locate at transcription start sites (TSSs) instead and are stable over evolutionary times.
...
However, the loss of hotspots brings recombination defects.
