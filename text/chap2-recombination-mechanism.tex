...
\begin{sidewaysfigure}[p]
	...
	{\textbf{Chromosome organisation diagrams and cytological pictures of the two meiotic divisions leading to the formation of four gametes.}
		...
		\par The micrographs show meiosis in a male lily while the diagrams show it in an animal cell.
...
But the prognosis regarding the equal number of COs and NCOs was never confirmed biologically \citep{bishop2004early} which suggested that a portion of NCOs were created \textit{via} another mechanism.
...
\begin{figure}[p]
	...
	{\textbf{Molecular mechanism of pathways leading to crossing-overs (COs) and non-crossovers (NCOs).}
		...
		This junction is then either dissolved into a NCO (left panel), resolved by canonical Holliday junction resolvases introducing a pair of symmetrical nicks to generate nicked DNA duplexes that can be directly ligated (middle panel) or resolved by noncanonical resolvases introducing asymmetrical nicks to produce gapped and flapped DNA duplexes that require further processing prior to ligation (bottom right panel).
...
In mice, a pair of nicks is introduced across the helical branchpoint of most (90\%) dHJs by the concerted action of the MLH1-MLH3 heterodimer \citep{baker1996involvement, edelmann1996meiotic,lipkin2002meiotic} and of EXO1 \citep{wei2003inactivationa}.
