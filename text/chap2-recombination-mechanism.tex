...
% The co-directional segregation of sister chromatids is likely ensured by a system analogous to worms https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4683677/
...
\subsubsection{Four differential degrees of synapsis during prophase I}
...
Each is characterised by a particular chromosomal configuration that mirrors the degree of “synapsis” \textit{i.e.} pairing of homologues.

At leptotene, chromosomes ends connect to the cytoskeleton located outside the nucleus \citep{scherthan1996centromere} \textit{via} their binding to a complex body of SUN-domain proteins of the inner nuclear membrane (INM) that have beforehand bridged KASH-domain proteins of the outer nuclear membrane (ONM) \citep{tzur2006sun, yanowitz2010meiosis}.
% Concomitantly, DNA starts to break double-strandedly at several sites along the chromosomes.
This allows cytoplasmic forces to animate the motion of chromosome ends at the surface of the INM \citep{penkner2009meiotic} and ends at late leptotene by the formation of a “bouquet” (Figure~\ref{fig:prepairing}) \citep{zickler1998leptotene} in which the chromosomes are constrained in a limited area of the nucleus \citep{zickler2006early}.
...
Instead, the sex chromosomes are transcriptionnally inactivated (“meiotic sex chromosome inactivation”, or MSCI) by remodelling into heterochromatin \citep{fernandez2003h2ax} and they are pushed to the periphery of the nucleus where they form the “sex body” \citep{handel2004xy} (Figure~\ref{fig:prophase-I-stages}.e.).
Then, during diplotene, the homologous chromosomes desynapse but remain attached in pairs \textit{via} their chiasmata.
% Homologous chromosomes then desynapse during diplotene but the chiasmata keep homologues attached to one another.
...
\subsubsection{Presynaptic pairing and homology search}
...
This assumption relies on the observation that meiotic chromosomes solely pair when they are transcriptionally active \citep{cook1997transcriptional}. 
DNA duplexes could thus momentarily bind within the “transcription factory” to which DNA loops are attached in that case \citep{xu2008similar}.
...
% begins with the formation of DNA double-strand breaks (DSBs) that need to be repaired.
Instead, they propose that DSBs occur after a pre-leptotene pairing and that their repair serves as a prophase checkpoint to proofread the initial connection.
If that were so, homology search for DSB repair would be restrained to a reduced territory and thus, much facilitated \citep[cited in \citealp{boateng2013homologous}]{mirny2011fractal}.\\
...
% it is widely accepted that chromosomal movements are required both to create opportunities for homologues to encounter and to disrupt unwanted associations \citep{koszul2009dynamic} by allowing random collisions between chromosomes \citep{fung1998homologous}.
% Yet, at this stage, the interstitial interactions between homologous chromosomes are transient and reversible \citep{boateng2013homologous} and thus need to be strengthened by a higher-order chromosomal structure, the synaptonemal complex (SC).
% Indeed, mutations that impede chromosomal movements
% One particular unwanted association during meiotic homology search is that with the sister chromatid, which is ensured by the synaptonemal complex (SC).
...
\subsubsection{Role of the synaptonemal complex (SC)}
The synaptonemal complex (SC), discovered in 1956 \citep{fawcett1956fine,moses1956chromosomal} is a remarkably well-conserved ribbon-like proteinaceous structure composed of three units: two dense lateral (or axial) elements (LE) and one less dense central element (CE) (Figure~\ref{fig:synaptonemal-complex}) \citep{schmekel1995central}.

LEs resemble axes along which the chromatin loops of sister chromatids are loaded, by binding short stretches of DNA to the LE and condensing the rest into long loops of tens to hundreds of kilo bases (kb). Generally, loops located closer to the telomeres are much shorter than elsewhere \citep{heng1996regulation}.
...
The main consituent of TFs, the SCP1 protein in mammals, has homologues in worms \citep{macqueen2002synapsis,colaiacovo2003synaptonemal}, flies \citep{mckim2002meiotic} and yeasts \citep[reviewed in][]{zickler1999meiotic} that show little sequence conservation but share a similar structure: two head-to-head homodimers of a ${\sim}80$ nm coiled coil flanked by globular C and N termini \citep{meuwissen1992coiled,liu1996localization}.
...
Thus, switching this inter-sister bias to an inter-homologue bias is essential for synapsis.
...
Microscopy observation of the SC show dense nodules where recombination occurs (“recombination nodules”: RN) \citep{schmekel1998evidence}.
Indeed, the formation of DSBs is a prerequisite for SC formation for many species including plants and mammals \citep{zickler1999meiotic, henderson2004tying}.
Yet, the meiotic program seems to vary for other species: SC formation is recombination-independent in \textit{Caenorhabditis elegans} \citep{dernburg1998meiotic}, \textit{Bombyx mori} \citep{rasmussen1977transformation}\ and textit{Drosophila} females \citep{mckim1998meiotic} (and recombination does not even occur in \textit{Drosophila} males \citep[reviewed in][]{tsai2011homologous}) while \textit{Schizosaccharomyces pombe} \citep{bahler1993unusual} and \textit{Aspergillus nidulans} \citep{egel1982meiosis} have recombination but not SC \citep[reviewed in][]{zickler2015recombination}.

More generally, whenever recombination is associated with the SC, it is clear that the its correct formation is of paramount importance to create stable DNA connections between homologues \citep{hunter2001singleend} which appear through the process of meiotic recombination.

% Indeed, SC dissolves at diplotene, when connections are made.
...
%
% % HOMOLOGUE PAIRING ORIGIN
% Origin of homolgue pairing: https://royalsocietypublishing.org/doi/10.1098/rstb.2016.0001
%
%
% % DIFF MEIOSE MITOSE
