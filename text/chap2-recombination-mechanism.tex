...
% Most sexually-reproducing beings have diploid cells, \textit{i.e.} cells with two sets of chromosomes: one from each parent.
% The transmission of half this genetic material to the progeny goes through the formation of specialised haploid cells (\textit{i.e.} counting a single set of chromosomes) called ‘gametes’.
...
Most sexually-reproducing organisms have diploid cells, \textit{i.e.} cells counting two sets of chromosomes: one from each parent.
The transmission of half this genetic material to the progeny goes through the formation of specialised haploid cells (\textit{i.e.} cells encompassing a single set of chromosomes) called ‘gametes’.
...
\begin{sidewaysfigure}[p]
	...
	{\textbf{Chromosome organisation diagrams and cytological pictures of the two meiotic divisions leading to the formation of four gametes.}
		...
		This figure was reproduced from \citet{hillis2012principles}.
	}
...
% \footnote{Except for species with holocentric chromosomes (\textit{i.e.} chromosomes devoid of any major centromeric constriction), like Lepidoptera, aphids and nematodes.}
...
Thence, before entering meiosis, each homologous chromosome (or ‘homologue’) \textit{i.e.} each parental copy, is formed of two identical double-helix DNA molecules called ‘sister chromatids’ which are physically attached at a point called the ‘centromere’\footnote{Except for species with holocentric chromosomes (\textit{i.e.} chromosomes devoid of any major centromeric constriction), like Lepidoptera, aphids and nematodes.} and adjoined along their whole length by cohesins \citep{klein1999central}.
...
\begin{figure}[h]
	...
	{\textbf{Mouse preleptotene DSB-independent pairing model proposed by \citet{boateng2013homologous}.}
		...
		\par This figure was reproduced from \citet{boateng2013homologous}.
		}
...
In accordance with this hypothesis, the frequency of Down Syndrome (a.k.a.\ trisomy 21) \citep{penrose2009relative} and other human trisomies \citep{morton1988maternal} are positively correlated with maternal age. 
...
Distinguishing between HR and NAHR implies knowing where recombination effectively takes place on the genome, which is the subject of the next chapter.
