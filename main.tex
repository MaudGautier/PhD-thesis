...
% To keep my old font size even if not the case in cover page
% from: https://tex.stackexchange.com/questions/423334/how-to-store-and-restore-the-current-font-size
\makeatletter
...
% DEPUIS: http://monbloginformatique.blogspot.com/2010/03/hyperref-avec-backref-comment-afficher.html
...
% \or \mapolicebackref{Cited on page \href[page={#2}]{#2}}
% \or \mapolicebackref{Cited on page \hyperlink{page.{#2}}{#2}}
% \or \mapolicebackref{Cited on page \hyperlink{page.{#2}}{page.#2}}
% \or \mapolicebackref{Cited on page \hyperlink{page.22}{#2}}
% \or \mapolicebackref{Cited on page \bookmark[page={#2}]{#2}}
...
% \renewcommand\backrefpagesname{\(\rightarrow\) p.~}
\bibinput{references}
...
\end{center}
   %  \begin{center}
	  %   \Large \bfseries Recombination as a driver of genome evolution: characterisation of biased gene conversion in mice
...
% \addcontentsline{toc}{chapter}{R\'esum\'e en francais}
% \addcontentsline{toc}{chapter}{Remerciements}
% \addcontentsline{toc}{chapter}{R\'esum\'e \'etendu en francais}
...
%%%%% CHAPTERS
\pagenumbering{arabic} % Add page numbering after removing it for pre-textual pages
...
% \bibintoc
% % Inspire de https://tex.stackexchange.com/questions/75621/remove-bibliography-entry-from-toc-or-change-the-way-it-is-displayed
...
\bibliography{references,bibliography_additional/Bibtex/01_chronology_recombination,bibliography_additional/Bibtex/chap3_RR_variation_and_evolution,bibliography_additional/Bibtex/chap4_gBGC,bibliography_additional/Bibtex/chap5_methodology,bibliography_additional/Bibtex/chap6_recombination_parameters,bibliography_additional/Bibtex/chap7_quantification_BGC,bibliography_additional/Bibtex/chap8_HFM1,bibliography_additional/Bibtex/chap10_philosophising,bibliography_additional/Bibtex/chap1_section3,bibliography_additional/Bibtex/chap9_discussion}
